  ...
  return (
    ...
    <Context.Provider value={contexto}>
      ...
      <Routes>
        ...
        <Route path="/movie" element={<PeliculasFiltro />} />{/*muestra peliculas: populares/mejores criticas/ a estrenarse/ en cine.*/}
        ...
        <Route path="/movie/:id/info" element={<InfoPelicula />} /> {/*Detalle info de la pelicula elegida*/}
        ...
        <Route path="/tv" element={<SeriesFiltro />}/> {/*muestra series: populares/mejores criticas/ al aire*/}
        ...
        <Route path="/tv/:id/info" element={<InfoSerie />} />  {/*Detalle info de la serie elegida*/}
